...
import ReCreateDbTable from './components/configuration/recreateDbTable/recreateDbTable';
const AppRouter = () => {
  return (
    <Router>
      <Switch>
        ...
        <Route path="/configuration/buildDbTable" component={ReCreateDbTable} exact />
      </Switch>
    </Router>
  )
}
